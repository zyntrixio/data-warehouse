...
DESCRIPTION:
    DATASOURCE TO PRODUCE TABLEAU DASHBOARD FOR STONEGATE GROUP - AGG VIEW GROWTH
PARAMETERS:
    SOURCE_OBJECT       - LC__LINKS_JOINS__MONTHLY_RETAILER__GROWTH
                        - TRANS__TRANS__MONTHLY_RETAILER__GROWTH
                        - TRANS__AVG__MONTHLY_RETAILER__GROWTH
                        - USER__TRANSACTIONS__MONTHLY_RETAILER__GROWTH
                        - LC__PLL__MONTHLY_RETAILER__GROWTH
*/
...
combine_all AS (
    SELECT
        ...
        NULL AS t010__refund__monthly_retailer__sum__growth,
    ...
    SELECT
        ...
        NULL AS lc334__successful_loyalty_card_join_mrkt_opt_in_per_successful_loyalty_card_join__monthly_retailer__percentage__growth,
        NULL AS lc201__loyalty_card_active_pll__monthly_retailer__pit__growth,
        NULL AS u107_active_users__retailer_monthly__dcount_uid__growth,
        NULL AS u108_active_users_retailer_monthly__cdcount_uid__growth,
        t011__txns__monthly_retailer__dcount__growth,
        t012__refund__monthly_retailer__dcount__growth,
        t010__refund__monthly_retailer__sum__growth,
