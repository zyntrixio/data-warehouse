...
,combine AS (
    SELECT
        ...
        ,STATUS_ROLLUP
        ,LC101__ERROR_LOYALTY_CARDS__DAILY_USER_LEVEL__NULL
        ,LC102__RESOLVED_ERROR_LOYALTY_CARDS__DAILY_USER_LEVEL__NULL
        ,LC103__ERROR_VISITS__DAILY_USER_LEVEL__NULL
    ...
    SELECT
        ...
        ,NULL AS LC101__ERROR_LOYALTY_CARDS__DAILY_USER_LEVEL__NULL
        ,NULL AS LC102__RESOLVED_ERROR_LOYALTY_CARDS__DAILY_USER_LEVEL__NULL
        ,NULL AS LC103__ERROR_VISITS__DAILY_USER_LEVEL__NULL
