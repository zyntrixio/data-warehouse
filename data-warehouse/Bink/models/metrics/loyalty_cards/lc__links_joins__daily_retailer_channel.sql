...
,add_combine_rename AS (
    SELECT
        ...
        ,JOIN_REQUESTS_UNIQUE_USERS                                 AS LC018__REQUESTS_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_RETAILER__DCOUNT
        ,JOIN_FAILS_UNIQUE_USERS                                    AS LC023__FAILED_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_RETAILER__DCOUNT
        ,JOIN_SUCCESSES_UNIQUE_USERS                                AS LC021__SUCCESSFUL_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_RETAILER__DCOUNT
        ,JOIN_DELETES_UNIQUE_USERS                                  AS LC024__DELETED_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_RETAILER__DCOUNT
        ,LINK_REQUESTS_UNIQUE_USERS                                 AS LC022__REQUESTS_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_RETAILER__DCOUNT
        ,LINK_FAILS_UNIQUE_USERS                                    AS LC019__FAILED_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_RETAILER__DCOUNT
        ,LINK_SUCCESSES_UNIQUE_USERS                                AS LC017__SUCCESSFUL_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_RETAILER__DCOUNT
        ,LINK_DELETES_UNIQUE_USERS                                  AS LC020__DELETED_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_RETAILER__DCOUNT
