...
,add_combine_rename AS (
    SELECT
        ...
        ,JOIN_SUCCESS_STATE                                          AS LC029__SUCCESSFUL_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,JOIN_FAILED_STATE                                           AS LC031__FAILED_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,JOIN_PENDING_STATE                                          AS LC030__REQUESTS_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,JOIN_REMOVED_STATE                                          AS LC032__DELETED_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,LINK_SUCCESS_STATE                                          AS LC025__SUCCESSFUL_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,LINK_FAILED_STATE                                           AS LC027__FAILED_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,LINK_PENDING_STATE                                          AS LC026__REQUESTS_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,LINK_REMOVED_STATE                                          AS LC028__DELETED_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,JOIN_SUCCESS_STATE+LINK_SUCCESS_STATE                       AS LC001__SUCCESSFUL_LOYALTY_CARDS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,JOIN_PENDING_STATE+LINK_PENDING_STATE                       AS LC002__REQUESTS_LOYALTY_CARDS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,JOIN_FAILED_STATE+LINK_FAILED_STATE                         AS LC003__FAILED_LOYALTY_CARDS__DAILY_CHANNEL_BRAND_MERCHANT__PIT
        ,LINK_REMOVED_STATE+JOIN_REMOVED_STATE                       AS LC004__DELETED_LOYALTY_CARDS__DAILY_CHANNEL_BRAND_MERCHANT__PIT

        ,JOIN_REQUESTS                                              AS LC014__REQUESTS_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,JOIN_FAILS                                                 AS LC015__FAILED_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,JOIN_SUCCESSES                                             AS LC013__SUCCESSFUL_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,JOIN_DELETES                                               AS LC016__DELETED_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,LINK_REQUESTS                                              AS LC010__REQUESTS_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,LINK_FAILS                                                 AS LC011__FAILED_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,LINK_SUCCESSES                                             AS LC009__SUCCESSFUL_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,LINK_DELETES                                               AS LC012__DELETED_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,JOIN_REQUESTS + LINK_REQUESTS                              AS LC006__REQUESTS_LOYALTY_CARDS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,JOIN_FAILS + LINK_FAILS                                    AS LC007__FAILED_LOYALTY_CARDS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,JOIN_SUCCESSES + LINK_SUCCESSES                            AS LC005__SUCCESSFUL_LOYALTY_CARDS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT
        ,JOIN_DELETES + LINK_DELETES                                AS LC008__DELETED_LOYALTY_CARDS__DAILY_CHANNEL_BRAND_MERCHANT__COUNT

        ,JOIN_REQUESTS_UNIQUE_USERS                                 AS LC018__REQUESTS_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__DCOUNT
        ,JOIN_FAILS_UNIQUE_USERS                                    AS LC023__FAILED_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__DCOUNT
        ,JOIN_SUCCESSES_UNIQUE_USERS                                AS LC021__SUCCESSFUL_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__DCOUNT
        ,JOIN_DELETES_UNIQUE_USERS                                  AS LC024__DELETED_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__DCOUNT
        ,LINK_REQUESTS_UNIQUE_USERS                                 AS LC022__REQUESTS_LOYALTY_CARD_JOINS__DAILY_CHANNEL_BRAND_MERCHANT__DCOUNT
        ,LINK_FAILS_UNIQUE_USERS                                    AS LC019__FAILED_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__DCOUNT
        ,LINK_SUCCESSES_UNIQUE_USERS                                AS LC017__SUCCESSFUL_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__DCOUNT
        ,LINK_DELETES_UNIQUE_USERS                                  AS LC020__DELETED_LOYALTY_CARD_LINKS__DAILY_CHANNEL_BRAND_MERCHANT__DCOUNT
