...
with
    ...
    adding_cumulative_abs as (
        ...
        select
            ...
            sum(join_requests) over (
                partition by loyalty_plan_company, loyalty_plan_name order by date asc
    ...
    add_combine_rename as (
        select
            ...
            join_pending_state
            + link_pending_state as lc336__requests_loyalty_cards__monthly_retailer__pit
            ,
            join_failed_state
            + link_failed_state as lc337__failed_loyalty_cards__monthly_retailer__pit,
            link_removed_state
            + join_removed_state as lc338__deleted_loyalty_cards__monthly_retailer__pit,
            link_success_state
            ...
            join_successes
            + link_successes as lc339__successful_loyalty_cards__monthly_retailer__count
            ,
            join_requests
            + link_requests as lc340__requests_loyalty_cards__monthly_retailer__count,
            join_fails
