...
with
    ...
    status_change_events_select as (
        ...
        left join account_status_lookup asl_from on sce.from_status_id = asl_from.code
    ...
    union_old_lc_records as (
        ...
        from {{ this }}
        where
            loyalty_card_id in (select loyalty_card_id from status_change_events_select)
        {% endif %}
    ),
