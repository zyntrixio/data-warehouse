...
,select_transactions as (
	SELECT
		...
		,SPEND_MULTIPLIER
		,TRANSACTION_DATE
		,SCHEME_TRANSACTION_ID :: VARCHAR AS SCHEME_TRANSACTION_ID
		,MERCHANT_IDENTIFIER_ID :: VARCHAR AS MERCHANT_IDENTIFIER_ID
		,PAYMENT_TRANSACTION_ID :: VARCHAR AS PAYMENT_TRANSACTION_ID
	FROM
		transactions		
)
